# aşağıdaki öğrenci bilgilerini dictionary listesinde saklayınız.
   ...
   # Ada Bilgi 2012(80,80,80)
   # Çınar Turan 2017(70,70,70)
...
# 101 numaralı Yiğit Bilgi isminedki öğrencinin yaşı 14 ve not ortalaması 70


print(f"{ogrenciNo} numaralı {ogrenci["Ad"]} {ogrenci["Soyad"] } ismindeki öğrencinin not ortalaması {ortalama}. ")
